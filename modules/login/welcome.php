                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div><span>Total Sertifikat PSEF</span>
                                                <h3 class="font-medium m-b-0" id="total_perizinan"></h3></div>
                                        </div>
                                    </div>
                                    <!-- <div class="col-lg-3 col-md-6">
                                        <div class="d-flex align-items-center">
...
<script>
    ...
    $(document).ready(function() {
        ...
        switch (role) {
            case 'Psef.Verifikator': cek_pending_permohonan('VerifikatorPendingTotal','pending_verif','Verifikator');
            break;
        
            case 'Psef.Kasi': cek_pending_permohonan('KepalaSeksiPendingTotal','pending_kasi','KepalaSeksi');
            break;
        
            case 'Psef.Kasubdit': cek_pending_permohonan('KepalaSubDirektoratPendingTotal','pending_kasubdit','KepalaSubDirektorat');
            break;

            case 'Psef.Diryanfar': cek_pending_permohonan('DirekturPelayananFarmasiPendingTotal','pending_diryanfar','DirekturPelayananFarmasi');
            break;

            case 'Psef.Dirjen': cek_pending_permohonan('DirekturJenderalPendingTotal','pending_dirjen','DirekturJenderal');
            break;

            case 'Psef.ValidatorSertifikat': cek_pending_permohonan('ValidatorSertifikatPendingTotal','pending_validator','ValidatorSertifikat');
            break;
