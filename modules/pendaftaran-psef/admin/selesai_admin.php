    ...
    <div class="row">
        ...
        <div class="col-7 align-self-center">
            <div class="d-flex no-block justify-content-end align-items-center" id="refresh-page">
                <button onclick="routing('selesai_admin')" type="button" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-redo"></i> Segarkan Halaman</button>
            </div>
        </div>
    </div>
</div>
...
<script id="view-data" type="text/x-handlebars-template">
    ...
    <form class="m-t-30">
        ...
        <button type="button" class="btn btn-danger" onclick="routing('selesai_admin')">Kembali</button>
    </form>
</script>
