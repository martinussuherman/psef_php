  ...
  <h4 class="card-title">Tambah Permohonan</h4>
    <form class="m-t-30 needs-validation" id="add-data-new" onsubmit="data_save(event)" novalidate>
        ...
        <div class="form-group">
          ...
          <div class="border px-3 py-1 mb-2" style="background-color: #e9ecef;">
            <a href="https://psef.kemkes.go.id/assets/doc/Contoh%20Surat%20Pernyataan%20Komitmen%20Bekerjasama%20dengan%20Apotek.docx">Contoh Surat Pernyataan Komitmen bekerjasama dengan Apotek</a>
          </div>
        </div>
        <div class="form-group">
