...
<script id="view-data" type="text/x-handlebars-template">
    ...
    <div class="col-sm-12">
        ...
        <button type="button" class="btn btn-danger" onclick="routing('pending_validator')">Kembali</button>
        <button type="button" class="btn btn-success" onclick="process_data('{{data_permohonan.id}}')">Proses Data</button>
    </form>
</script>
