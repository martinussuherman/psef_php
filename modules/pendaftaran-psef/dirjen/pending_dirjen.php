    ...
    <div class="row">
        ...
        <div class="col-7 align-self-center">
            <div class="d-flex no-block justify-content-end align-items-center" id="refresh-page">
                <button onclick="routing('pending_dirjen')" type="button" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-redo"></i> Segarkan Halaman</button>
            </div>
        </div>
    </div>
</div>
...
<script id="view-data" type="text/x-handlebars-template">
    ...
    <div class="col-sm-12">
        ...
        <button type="button" class="btn btn-danger" onclick="routing('pending_dirjen')">Kembali</button>
...
<script>
    ...
    $(document).ready(function() { 
        $('#zero_config').on('xhr.dt', function ( e, settings, json, xhr ) {
            ...
            "data": function ( d ) {
                ...
                data.fsort = 'desc';
                data.fmodul = 'Permohonan/DirekturJenderalPending';
    ...
    function reject_data(id){
        Swal.mixin({
            ...
            if (result.value) {
                $.ajax({
                    url: url_api_x+'Permohonan/DirekturJenderalKembalikan',
                    type: 'POST',
    ...
    function process_data(id){
        ...
        swal({
            ...
            if (result.value) {
                $.ajax({
                    url: url_api_x+'Permohonan/DirekturJenderalSetujui',
                    type: 'POST',
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader('Authorization', 'Bearer '+accesstoken+'');
                    },
