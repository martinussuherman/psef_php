<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title" id="page-title">Permohonan (Pending)</h4>
        ...
        <div class="col-7 align-self-center">
            <div class="d-flex no-block justify-content-end align-items-center" id="refresh-page">
                <button onclick="routing('pending_verif')" type="button" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-redo"></i> Segarkan Halaman</button>
            </div>
        </div>
    </div>
</div>
...
<script id="view-data" type="text/x-handlebars-template">
    ...
    <div class="col-sm-12">
        ...
        <button type="button" class="btn btn-danger" onclick="routing('pending_verif')">Kembali</button>
    ...
    $(document).ready(function() { 
        $('#zero_config').on('xhr.dt', function ( e, settings, json, xhr ) {
            ...
            "dataSrc": function ( json ) {
                ...
                datax.push('<p>'+json.data[i].statusName+'</p><hr style="display: inline;border: 7px solid '+color_userLevelDays+';">&nbsp;User Days : '+json.data[i].userLevelDays+'</hr>');
            ...
            "data": function ( d ) {
                ...
                data.fsort = 'desc';
                data.fmodul = 'Permohonan/VerifikatorPending';
