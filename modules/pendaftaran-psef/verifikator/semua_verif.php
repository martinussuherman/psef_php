    ...
    <div class="row">
        ...
        <div class="col-7 align-self-center">
            <div class="d-flex no-block justify-content-end align-items-center" id="refresh-page">
                <button onclick="routing('semua_verif')" type="button" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-redo"></i> Segarkan Halaman</button>
            </div>
        </div>
    </div>
</div>
...
<script id="view-data" type="text/x-handlebars-template">
    ...
    <div class="col-sm-12">
        ...
        <button type="button" class="btn btn-danger" onclick="routing('semua_verif')">Kembali</button>
    </form>
</script>
