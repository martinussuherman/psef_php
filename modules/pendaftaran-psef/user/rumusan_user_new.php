<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title" id="page-title">Permohonan (Rumusan) New</h4>
        ...
        <div class="col-7 align-self-center">
            <div class="d-flex no-block justify-content-end align-items-center" id="refresh-page">
                <button onclick="routing('rumusan_new')" type="button" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-redo"></i> Segarkan Halaman</button>
            </div>
        </div>
    </div>
</div>
...
<script id="add-data" type="text/x-handlebars-template">
    ...
    <form class="m-t-30" id="add-data-new" onsubmit="data_save(event)">
        ...
        <div class="row">
            ...
            <div class="col-7 align-self-center">
                <div class="d-flex no-block justify-content-end align-items-center">
                    <button type="button" class="btn-open-modal btn waves-effect waves-light btn-info" data-toggle="modal" data-target="#myModal" style="display:none;">Tambah Apotek</button>
                    <button type="button" class="btn-trigger-modal btn waves-effect waves-light btn-info" >Tambah Apotek</button>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            ...
            <div class="col-7 align-self-center">
                <div class="d-flex no-block justify-content-end align-items-center">
                    <button type="button" class="btn-open-modal-klinik btn waves-effect waves-light btn-info" data-toggle="modal" data-target="#myModalKlinik" style="display:none;">Tambah Klinik</button>
                    <button type="button" class="btn-trigger-modal-klinik btn waves-effect waves-light btn-info" >Tambah Klinik</button>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="row">
            ...
            <div class="col-7 align-self-center">
                <div class="d-flex no-block justify-content-end align-items-center">
                    <button type="button" class="btn-open-modal-rs btn waves-effect waves-light btn-info" data-toggle="modal" data-target="#myModalRs" style="display:none;">Tambah Rumah Sakit</button>
                    <button type="button" class="btn-trigger-modal-rs btn waves-effect waves-light btn-info" >Tambah Rumah Sakit</button>
                </div>
            </div>
        </div>
        <br>
...
<script id="edit-data-apotek" type="text/x-handlebars-template">
    <div class="row">
        ...
        <div class="col-5 align-self-center">
            <div class="d-flex no-block justify-content-end align-items-center" id="add_data">
                <button onclick="routing('rumusan_new')" type="button" class="btn waves-effect waves-light btn-danger btn-add-data">Kembali ke Data Permohonan</button>
            </div>
        </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form class="m-t-30" id="add_detail_data_klinik" onsubmit="detail_add_klinik(event)">
                    ...
                    <div class="form-group">
                        <label>No SIA</label>
                        <input  type="text" class="form-control" id="siaNumber_klinik" name="siaNumber" placeholder="Masukan No SIA" required>
                    </div>
                    <div class="form-group">
                        <label>Nama Apoteker</label>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form class="m-t-30" id="add_detail_data_rs" onsubmit="detail_add_rs(event)">
                    ...
                    <div class="form-group">
                        <label>No SIA</label>
                        <input  type="text" class="form-control" id="siaNumber_rs" name="siaNumber" placeholder="Masukan No SIA" required>
                    </div>
                    <div class="form-group">
                        <label>Nama Apoteker</label>
...
<div id="modal-pakta" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document" style="max-width: 80%;">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-dismiss="modal" id="modal-pakta-setuju">Setuju</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal">Tidak Setuju</button>
      </div>
    </div>
  </div>
</div>
...
<script>
    ...
    function detail_add_klinik(e){
        ...
        arr_detail_add_klinik.push(
            {"name": data.name,"permohonanId": 0,"siaNumber": data.siaNumber,"apotekerName": data.apotekerName,"straNumber": data.straNumber,"sipaNumber": data.sipaNumber,"address": data.address,"provinsiId": data.provinsiId,"iddetail":id_detail_add_klinik}
        )
    ...
    function edit_detail_add_klinik(id){
        $.each(arr_detail_add_klinik, function( i, v ) {
            if(id==v.iddetail){
                ...
                $("#siaNumber_klinik").val(v.siaNumber)
    ...
    function detail_add_rs(e){
        ...
        arr_detail_add_rs.push(
            {"name": data.name,"permohonanId": 0,"siaNumber": data.siaNumber,"apotekerName": data.apotekerName,"straNumber": data.straNumber,"sipaNumber": data.sipaNumber,"address": data.address,"provinsiId": data.provinsiId,"iddetail":id_detail_add_rs}
        )
