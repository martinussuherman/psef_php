    ...
    <div class="row">
        ...
        <div class="col-7 align-self-center">
            <div class="d-flex no-block justify-content-end align-items-center" id="refresh-page">
                <button onclick="routing('proses_user')" type="button" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-redo"></i> Refresh Page</button>
            </div>
        </div>
    </div>
</div>
    ...
    <form class="m-t-30" id="add-data-new" onsubmit="data_save(event)">
        ...
        <div class="form-group">
            ...
            <div class="border p-10" style="background-color: #e9ecef;padding: .375rem .75rem;">
                <a href="https://psef.kemkes.go.id/assets/doc/Tamplate%20PSE%20(KEMENKES%20PSEF).docx">Unduh Contoh Permohonan.docx</a>
            </div>
        </div>
        <div class="form-group">
...
<script id="view-data" type="text/x-handlebars-template">
    ...
    <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label">Phone Apoteker</label>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label">Expired STRA</label>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label class="control-label">Dok. Proses Bisnis</label>
                    <div class="border p-10" style="background-color: #e9ecef;padding: .375rem .75rem;">
        ...
        <button type="button" class="btn btn-danger" onclick="routing('proses_user')">Back</button>
    </form>
</script>
...
<script>
    ...
    $(document).ready(function() { 
        $('#zero_config').on('xhr.dt', function ( e, settings, json, xhr ) {
            ...
            "dataSrc": function ( json ) {
                ...
                var actions = '<td><button onclick="view_data(\''+json.data[i].id+'\')" type="button" class="btn btn-xs btn-block waves-effect waves-light btn-info">View Data</button>';
    ...
    function view_data_detail(data_permohonan, data_apotek){
